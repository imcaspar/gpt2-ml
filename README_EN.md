...
- [x] Simplifed GPT2 train scripts（based on grover, supports TPUs）
...
## Google Colab
With only 3 clicks (not including Colab auth process), the 1.5B pretrained Chinese model demo is ready to go：
